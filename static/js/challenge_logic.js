...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
    ...
    // This function returns the style data for each of the earthquakes we plot on the map. We pass the magnitude 
    // of the earthquake into a function to calculate the radius.
    ...
    L.geoJSON(data, {
        ...
        // We create a popup for each circleMarker to display the magnitude and location of the earthquake after 
        // the marker has been created and styled.
    ...
    d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data2) {

        // Using the same style as the earthquake data.
        ...
        // Using a GeoJSON layer with the retrieved data to add a circle to the map, set the style of the circle, 
        // and display the magnitude and location of the earthquake after the marker has been created and styled.
        L.geoJson(data2, {
    ...
    d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data3) {
